...
countries_list = [ "India", "Turkey", "Iran", "Indonesia", "Philippines", "Japan",
            ...
            "Spain", "Poland", "Netherlands", "Ukraine", "Belgium", "USA", "Mexico", "Canada",
...
# list_of_all_country_data = 
print("Printing data country names" )
for country_data in list_of_all_country_data:
    print (country_data.country_name, type(country_data.country_name))
...
def menuInit():
    ...
    print("If you'd like to return to main menu of assignment 5, please enter 'main' at the next prompt.")
    print('To view the possible inputs, please enter help')
    print('Else, please enter the name of the country you wish to see the results for')
...
def dateRangeQuestionEntryPoint(country):
    ...
    # print("in historical data fn")
    # for country_data in list_of_all_country_data:
    #     print (country, country_data.country_name, country == country_data.country_name)
