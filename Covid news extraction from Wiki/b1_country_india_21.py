...
def dateFormatting( date_in_str):
    ...
    # date_list[2] = int(month_fm_suffix_list[1][2:])
    date_list[2] = 2021
...
def parseWorldWideNews():
    # url_suffixes = ['January_2020', 'February_2020', 'March_2020', 'April_2020',
    #     'May_2020', 'June_2020', 'July_2020', 'August_On 6 January to 3pm, a total of 684,227 cases of COVID-19 were reported in Australia, 2,301 deaths, and there were approximately 330,289 active cases. 56,326,500 tests had been done, 1.2% were positive.2020', 'September_2020',
    ...
    #     'January_2022', 'February_2022']
    
    # url_suffixes = ['Australia_(January–June_2021)']
    url_suffixes = [['India_(2021)', 3315, 3495]]
    ...
    for suffix in url_suffixes:
        ...
        tokens = [ 'NEWS', 'BREAK', 'DATE_ANCHOR', 'DATE']
    ...
    # ########################## End Of Lexer #########################################
        ...
        def p_news(t):
            '''news : DATE NEWS'''
            dd_mm_list = dateFormatting(t[1])
            news_clean_str = cleanReadData(t[2])
           
            # print ("Clean news : ", dd_mm_list, news_clean_str) 




            # dd_mm_news_list = splitDateNews(str_clean)

            # print (f'DD MM  :{dd_mm_list[0]}: , :{dd_mm_list[1]}:')
            ...
            # print (dd_mm_list[0])
            # print ("ds1", dd_mm_list[1])

            # suffix = dd_mm_news_list[1] + " 2020"
            # str_date = str(dd_mm_news_list[0]) + " " + dd_mm_news_list[1]

            news_instance = newsItems()
            news_instance.day = dd_mm_list[0]
            news_instance.month = dd_mm_list[1]
            news_instance.year = dd_mm_list[2]
            news_instance.news = news_clean_str
            news_instance.country = 'India'
