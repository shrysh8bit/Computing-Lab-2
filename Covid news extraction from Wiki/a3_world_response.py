...
def parseWorldWideResponse():
    url_suffixes = [['January_2020', 360, 560],['February_2020', 380, 885], ['March_2020', 370, 900],
        ['April_2020', 545, 1765], ['May_2020',450, 1090 ], ['June_2020', 490, 1175], 
        ['July_2020', 530, 1406], ['August_2020', 430, 805], ['September_2020', 365, 480],
        ['October_2020', 365, 475], ['November_2020', 345, 400], ['December_2020', 365, 435], 
        ['January_2021', 355, 420], ['February_2021', 360, 440], ['March_2021', 345, 390],  
        ['April_2021', 345, 395], ['May_2021',360, 432], ['June_2021', 360, 416], 
        ['July_2021', 348, 395],['August_2021', 350, 405], ['September_2021', 355, 420], 
        ['October_2021', 359, 420], ['November_2021', 370, 450], ['December_2021',355, 410 ],
        ['January_2022', 355, 425], ['February_2022', 340, 378]]
    
    # url_suffixes = ['January_2020']
    for suffix in url_suffixes:

        base_url = 'https://en.wikipedia.org/wiki/Responses_to_the_COVID-19_pandemic_in_'
        ...
        tokens = [ 'START_POINT', 'DATE_ANCHOR', 'DATE', 'NEWS']
    
        def t_START_POINT(t):
            r'chronology\">.*logy</span'
            return t
    ...
    # ########################## End Of Lexer #########################################
        ...
        def p_news(t):
            ...
            if news_instance.day != 0:
                ...
                date_response.append(news_instance)
            #     print("Date valid")
            # else:
