...
def parseWorldWideNews():
    ...
    for suffix in url_suffixes:
        ...
        # html_data_str = splitInputStr(html_data_str, 4490, 4675)
        # html_data_str = cleanReadData(html_data_str)


        print (suffix[0], len(html_data_str))


        tokens = ['MM_YYYY_ANCHOR', 'MM_YYYY', 'BREAK', 'DATE', 'NEWS',  ]
        ...
        def t_BREAK(t):
            r'<span.class=\"mw-editsection\">|<h2>|<\/li>'
            return t
    ...
    # ########################## End Of Lexer #########################################
        ...
        def p_news(t):
            ...
            news_clean_str = cleanReadData(date_news_list[1])
            dd_mm_yy_list = dateFormatting(date_news_list[0])
           
            # print ("Clean news : ", dd_mm_yy_list[0], dd_mm_yy_list[1], dd_mm_yy_list[2]) 
