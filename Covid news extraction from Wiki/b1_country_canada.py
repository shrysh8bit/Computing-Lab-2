...
def dateFormatting( date_in_str):
    ...
    date_list = [0]*3
    date_list[0] = int(dd_mm_list[-1])
    
    
    month_str = dd_mm_list[-2]
...
def parseWorldWideNews():
    ...
    url_suffixes = [['Canada', 41490, 41650]]
    ...
    for suffix in url_suffixes:
        ...
        tokens = ['YEAR_ANCHOR','YEAR', 'MM_YYYY', 'NEWS', 'BREAK', 'DATE',   ]
