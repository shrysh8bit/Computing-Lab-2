...
def parseWorldWideNews():
    ...
    url_suffixes = [['Australia_(January–June_2021)', 4340, 4560],['Australia_(July–December_2021)', 4330, 4530]]
    ...
    # ########################## End Of Lexer #########################################
        ...
        def p_news(t):
            ...
            # if(dd_mm_news_list[0] < '0' or dd_mm_news_list[0] > '9'):
            #     dd_mm_news_list[0] = 0
            ...
            for element in dd_mm_news_list[0]:
                if element < '0' or element > '9':
                    ...
                    dd_mm_news_list[1] = 'January'
                    break
            # dd_mm_news_list[0] = int(dd_mm_news_list[0])

            # print (dd_mm_list[0])
            # print ("ds1", dd_mm_list[1])

            suffix = dd_mm_news_list[1] + " 2021"
            ...
            news_instance.news = dd_mm_news_list[2]
