...
def parseWorldWideNews():
    ...
    url_suffixes = [['India_(June–December_2020)', 3320, 3640 ]]
    ...
    # ########################## End Of Lexer #########################################
        ...
        def p_news(t):
            '''news : DATE NEWS'''
            dt_str = t[1]
            news_str = cleanReadData(t[2])

            # print(dt_str, news_str)
            ...
            dd_mm_yy_list = dateFormatting(dt_str)
